...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public Player(int gold, int xp, int level, int currentHP, int maxHP) : base(currentHP, maxHP)
        {
            Gold = gold;
            XP = xp;
            Level = level;
        ...
        {
            //Als je in locatie bent, kijken of die object(Item) nodig heeft
            if (location.ItemYouNeedToEnter == null)
            {
            ...
            {
                if (ii.Details.ID == location.ItemYouNeedToEnter.ID)
                {
